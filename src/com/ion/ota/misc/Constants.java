 ...
 */
package com.ion.ota.misc;

import android.app.AlarmManager;

public class Constants {
    // Download related
    public static final String UPDATES_FOLDER = "ion";
    public static final String DOWNLOAD_ID = "download_id";
    public static final String DOWNLOAD_NAME = "download_name";
    public static final String DOWNLOAD_TMP_EXT = ".tmp";
    public static final String DOWNLOAD_CHANNEL_ID = "com.ion.ota.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "com.ion.ota.DOWNLOADING_CHANNEL";
    // Preferences
    ...
    // Build vars
    public static final String CURRENT_DEVICE_NAME = "ro.ion.device";
    public static final String CURRENT_VERSION = "ro.ion.version";
    public static final String CURRENT_BUILD_TYPE = "ro.ion.build_type";
    public static final String OTA_URL = "https://raw.githubusercontent.com/Sajidjnl/OTA/pie/%s";
    // Expressions
